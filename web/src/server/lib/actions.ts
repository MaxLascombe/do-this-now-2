...
// Whole-task snooze for a batch — backs "snooze this task and everything
// after it". Unlike snoozeTask this always pushes the whole task out (never
// just a subtask), banking any running timer. Unknown ids are skipped.
