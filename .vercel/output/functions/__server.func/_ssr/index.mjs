...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-V8w_n11g.mjs");
...
const manifest = { "c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d": {
  ...
  importer: () => import("./start.server-funcs-Dn8vG8R0.mjs")
  ...
  importer: () => import("./demo.punk-songs-BhpE38B8.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-VK4P8qu0.mjs").then((n2) => n2.r);
